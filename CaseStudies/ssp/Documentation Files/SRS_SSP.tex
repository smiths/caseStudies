...
\\
$a$ & \si{\meter}& Constant: FIXME: missing discription
\\
$A$ & \si{\meter}& Constant: FIXME: missing discription
\\
...
\\
$C1$ &  N\si{\meter}&Interslice Normal Force Function: FIXME: missing discription 
\\
$C2$ &  N\si{\meter}&Interslice Shear Force Function: FIXME: missing discription
\\
...
\\
${F_{x}}$ & \si{\newton} &X-Component of the Net Force: FIXME: missing discription
\\
${F_{y}}$ & \si{\newton} &Y-Component of the Net Force: FIXME: missing discription
\\
...
\\
$\kappa{}$ &\si{\pascal} & Constant: FIXME: missing discription
\\
...
movement can range from inconvenient to seriously hazardous, resulting
 in signifcant life and economic losses. Slope stability is of interest both 
...
program will be referred to as the Slope Stability Analysis (SSA) program. 
...
The SSA program determines the critical slip surface, and its respective factor of safety
...
SSA is intended to identify the most likely failure surface within the possible input
...
represents the software system itself (SSA Program).  Arrows are used to show the data
...
\item User Responsibilities:
  ...
  \end{itemize}
\item SSA Program Responsibilities:
  \begin{itemize}
