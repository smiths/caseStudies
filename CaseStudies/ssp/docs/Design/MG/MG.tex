...
\wss{Agreed.  I have now added your table to the blank project template.}
...
\wss{Agreed - good catch.  I have updated the blank project template}
...
\bmac{This section seems to cover the same topic as the traceability matrix in 
Section \ref{SecTM}. I am treating it as a place where I can provide more 
detailed justification for the design than can be found in a traceability 
matrix. Was that the intention for this section? My second paragraph here, in 
particular, might be out of place since it is related to anticipated changes 
and not requirements? Not sure where else to put it though. Maybe within 
Section \ref{SecTM} itself?}
...
interface.  In your case the choice of genetic algorithm is the concrete choice
that is made to satisfy the abstract requirement for optimization.}
...
\wss{Rather than call this module ``Array Data Structure'', I suggest ``Sequence
  Data Structure''.  This is a more general way to say it, and it means that
  this example will agree with some of the other examples.}
...
\wss{The makefile worked great for updating this table.  Thanks!}
