...
\begin{itemize}
	...
	\begin{itemize}
		...
		\textit{force}.Ub[i] = 
		{\ell{}_{b,i}}\begin{cases}
			\left({y_{wt,i}}-{y_{slip,i}}\right){\gamma{}_{w}}, & 
			{y_{wt,i}}>{y_{slip,i}}\\
			0, & {y_{wt,i}}\leq{}{y_{slip,i}}
			\end{cases}\\
			\land \textit{force}.Ut[i] = {\ell{}_{s,i}}\begin{cases}
			\left({y_{wt,i}}-{y_{us,i}}\right){\gamma{}_{w}}, & 
			{y_{wt,i}}>{y_{us,i}}\\
			...
			\left({y_{us,i}}-{y_{slip,i}}\right)\gamma{}, & 
			{y_{wt,i}}\leq{}{y_{slip,i}}
			\end{cases}\\
			...
			\arctan \left( \frac{y_\text{slip,i} -
				...
				\\
			\land \textit{angles}.\textit{beta}[i] = \arctan 
			\left( \frac{y_\text{us,i} -
				y_\text{us,i-1}}{x_\text{us,i} - x_\text{us,i-1}} \right)\\
			\land \textit{heights}[i] = 
			0.5*(({y_{us,i}}-{y_{slip,i}})+({y_{us,i+1}}-{y_{slip,i+1}})))$
	\end{itemize}
\end{itemize}
