...
slope's slip surface and to calculate the displacement that the slope will
 experience.
...
\item [GS\refstepcounter{goalnum}\thegoalnum: \label{G_Displacement}]
...
\begin{tabular}{| p{3cm} | p{12.5cm}|}
  ...
  \( \left[\begin{array}{l} p_\text{i} \\ p_\text{i} \end{array}
    \right] = \left[ \begin{array}{l l} K_\text{st,i} & 0 \\ 0 &
      K_\text{bn,i}\end{array} \right] \left[\begin{array}{l} \delta
      x_\text{i} \\ \delta y_\text{i}
    \end{array} \right] \) \\
