...
~\newline \noindent The test cases described in this section are intended to 
verify that all expected outputs are delivered by \progname{}, and that the 
output obeys the physical constraints described in Section 
\ref{SRS-sec_DataConstraints} of the SRS.
