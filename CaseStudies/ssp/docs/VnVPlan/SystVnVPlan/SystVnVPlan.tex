...
from \progname{} to results reported in literature for some specific example 
problems. In each test case, the literature sources to compare to will be given.
