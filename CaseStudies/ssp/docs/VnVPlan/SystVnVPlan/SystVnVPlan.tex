...
$\{\left(x_\text{slope},y_\text{slope}\right)\}$ increasing as $x$ increases, 
as 
follows: \{(0, 
...
\item [TC\refstepcounter{testnum}\thetestnum: \label{TC_ValidInXMinEtrEqual}] 
test-valid\_input\_xMinEtrEqual
...
\item [TC\refstepcounter{testnum}\thetestnum: \label{TC_ValidInXMaxExtEqual}] 
test-valid\_input\_xMaxExtEqual
...
\begin{table}[!h]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}
		...
		\hline
		\tcref{TC_ValidInDec} - \tcref{TC_ValidInXMaxExtEqual}                 
		& X& & & & & & & & & & \\ \hline
