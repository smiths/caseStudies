...
% Ex3.dat
SSA_InputSpecial ( './dataFiles/Ex3.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_NumLayerslow.dat', 0 );
%%
% <latex>
% \\ \cline{2-3} & overstate &
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_NumLayershigh.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_NumStratPointslow.dat', 0 );
%%
% <latex>
% \\ \cline{2-3} & overstate &
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_NumStratPointshigh.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_MissingSoilData.dat', 0 );
%%
% <latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_ExtraSoilData.dat', 0);
%%
% <latex>
% \\ \hline
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_ltor_lefttoright.dat', 0 );
%%
% <latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_ltor_righttoleft.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_nonmotonic_layer.dat', 0 );
%%
% <latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_nonmotonic_piez.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_xrange_layerendhigh.dat', 0 );
%%
% <latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_xrange_layerendlow.dat', 0 );
...
% Error_xrange_layerendlow.dat
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_xrange_layerstarthigh.dat', 0 );
%%
% <latex>
% \\ \cline{2-3} & start vertice \newline - low &
% </latex>
...
% Error_xrange_layerendlow.dat
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_xrange_layerstartlow.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_xrange_piezendhigh.dat', 0 );
%%
% <latex>
% \\ \cline{2-3} & end vertice \newline - low &
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_xrange_piezendlow.dat', 0 );
...
% Error_xrange_piezendlow.dat
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_xrange_piezstarthigh.dat', 0 );
%%
% <latex>
% \\ \cline{2-3} & start vertice \newline - low &
% </latex>
...
% Error_xrange_piezendlow.dat
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Error_xrange_piezstartlow.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Constraint_phihigh.dat', 0 );
%%
% <latex>
% \\ \cline{2-3} & $< 90$ &
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Constraint_philow.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
% Constraint_coh.dat
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Constraint_coh.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
% Constraint_gam.dat
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Constraint_gam.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
% Constraint_gams.dat
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Constraint_gams.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Constraint_nuhigh.dat', 0 );
%%
% <latex>
% \\ \cline{2-3} & $< 0$ &
% </latex>
...
SSA_InputSpecial ( './dataFiles/Faulty_Input_Files/Constraint_nulow.dat', 0 );
%%
% <latex>
% \\ \hline
% </latex>
