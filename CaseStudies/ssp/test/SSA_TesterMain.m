...
%%
% <latex>
% \input{..docs/VnVReport/VV_SubDocuments./SSA_RFEMSliceTester.tex}
% </latex>
...
%%
% <latex>
% \input{..docs/VnVReport/VV_SubDocuments./SSA_GenAlgTester.tex}
% </latex>
...
%%
% <latex>
% \input{..docs/VnVReport/VV_SubDocuments/SSA_KinAdmTester.tex}
% </latex>
...
%%
% <latex>
% \input{..docs/VnVReport/VV_SubDocuments/SSA_InputTester.tex}
% </latex>
publish('SSA_InputTester',...
    'format','latex','showCode',false,'imageFormat','png',...
    'stylesheet','../docs/VnVReport/VV_SubDocuments/latexsheet_Blank_NoVerbatim.xsl',...
    'outputDir','../docs/VnVReport/VV_SubDocuments')

%%
% <latex>
% \input{..docs/VnVReport/VV_SubDocuments/SSA_Ex6Tester.tex}
% </latex>
...
publish('SSA_TesterMain',... 
    ...
    'stylesheet','../docs/VnVReport/VV_SubDocuments/latexsheet_Main.xsl',...
    'outputDir','../docs/VnVReport')