...
& Circle Module \\
& &Segment Module \\
& &Polygon Module \\ %changed circle to polygon Module
& Space Module \\ 
& Arbiter Module \\
%& Control Module \\ 
...
\end{center}
\end{figure}
\olu {This section does not exist in the current template}
~\newpage
