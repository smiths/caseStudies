...
\begin{tabularx}{\textwidth}{p{3cm}p{2cm}X}
	...
	Dec. 25, 2018 & 1.2 & Updated with github feedback\\
	Jan. 3, 2018 & 1.3 & Updated with github feedback\\
	\bottomrule
\end{tabularx}
...
\begin{center}
	\begin{tabular}{p{4cm} p{4cm} p{4cm} p{2cm}}
		...
		\hline
		{BodyType} & & $\mathbb{Z}$ & BodyTypeError \\
		\hline
	\end{tabular}
\end{center}
...
& \textbf{Exceptions:} & None.\wss{Why aren't you checking that the mass is positive?} \olu{updated with exception for negative mass}\\ 
