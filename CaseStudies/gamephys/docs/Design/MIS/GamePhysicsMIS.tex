...
\textbf{apply_force:} & \textbf{Transition:} & apply_force will apply forces on the rigid bodies and it recalculates the total force acting on each body.  \\%& \textbf{Input:}  bodyUpdateVelocity accepts a Body pointer, a Vector and a double value as its input. \\
& \textbf{Output:} & None. \newfunc
& \textbf{Exceptions:} & None \\
