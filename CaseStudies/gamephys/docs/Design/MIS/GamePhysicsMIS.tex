...
%\textbf{apply_force:} & \textbf{Transition:} & apply_force will apply forces. And it recalculates the total force acting on a Body*.  \\%& \textbf{Input:}  bodyUpdateVelocity accepts a Body pointer, a Vector and a double value as its input. \\
%& \textbf{Exceptions:} & None \\
%
%& \textbf{Output:} & None. \newfunc
