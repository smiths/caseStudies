...
\usepackage{tabularx} \usepackage{booktabs} \usepackage[left=1in, right=1in,
top=1in, bottom=1in]{geometry} \title{CAS 741: Problem Statement\\Glass Breakage
Analysis} \author{Vajiheh Motamer} \date{\today}
