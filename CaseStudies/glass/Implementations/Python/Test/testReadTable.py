...
class TestReadTable(unittest.TestCase):
   ...
   def setUp(self):
        ...
        self.inputFileName    = [row[0]          for row in input] #--> ['testTable1.txt', 'testTable2.txt']
...
##fileName = testReadTable;
##inputFileName = testTable1.txt;
##[num_colShouldBe] = 4.5, 9.1, 14., 18;
##[array1Expctd] = [[ [6.143397364345, 6.128184215473, 6.344639409554, 7.199850837298],
