...
Label & Acceleration
\\ \midrule
\wss{Input} & \wss{$\symbf{v}: \mathbb{R} \rightarrow \mathbb{R}^3$}
\\ \midrule
\wss{Output} & \wss{$\symbf{a}: \mathbb{R} \rightarrow \mathbb{R}^3$}
\\ \midrule
...
\\ \midrule
\wss{Input} & \wss{$\symbf{p}: \mathbb{R} \rightarrow \mathbb{R}^3$}
\\ \midrule
\wss{Output} & \wss{$\symbf{v}: \mathbb{R} \rightarrow \mathbb{R}^3$}
\\ \midrule
\wss{Input Constraints} & \wss{None}
\\ \midrule
\wss{Output Constraints} & \wss{None}
...
\\ \midrule
\wss{Output} & \wss{${v}: \mathbb{R} \rightarrow \mathbb{R}$}
\\ \midrule
...
\\ \midrule
\wss{Output} & \wss{${p}: \mathbb{R} \rightarrow \mathbb{R}$}
\\ \midrule
\wss{Input Constraints} & \wss{$t \geq 0$} \wss{\hyperref[timeStartZero]{A:timeStartZero}}
\\ \midrule
\wss{Output Constraints} & \wss{None}
