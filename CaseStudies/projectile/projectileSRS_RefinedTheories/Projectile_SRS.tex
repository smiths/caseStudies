...
\item[gravAccel:\phantomsection\label{gravAccel}]{The acceleration is due to gravity. (RefBy: \hyperref{PT:velVecPlanetaryGrav}[PT:velVecPlanetaryGrav] and \hyperref{PT:posVecPlanetaryGrav}[PT:posVecPlanetaryGrav].)}
