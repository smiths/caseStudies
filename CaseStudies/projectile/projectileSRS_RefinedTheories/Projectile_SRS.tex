...
\begin{itemize}
\item[cartSyst:\phantomsection\label{oneD}]{The motion of the particle is one dimensional. (RefBy: \hyperref[GD:velVec]{GD:velVec} and \hyperref[GD:posVec]{GD:posVec}.)}
...
\subsubsection{\wss{Helper Theory Assumptions (GD:velVec, GD:posVec)}}
...
Label & Acceleration
\\ \midrule
\wss{Input} & \wss{$\symbf{v}(t): \mathbb{R} \rightarrow \mathbb{R}^3$}
\\ \midrule
\wss{Output} & \wss{$\symbf{a}(t): \mathbb{R} \rightarrow \mathbb{R}^3$}
\\ \midrule
...
\\ \midrule
\wss{Input} & \wss{$\symbf{p}(t): \mathbb{R} \rightarrow \mathbb{R}^3$}
\\ \midrule
\wss{Output} & \wss{$\symbf{v}(t): \mathbb{R} \rightarrow \mathbb{R}^3$}
\\ \midrule
\wss{Input Constraints} & \wss{None}
\\ \midrule
\wss{Output Constraints} & \wss{None}
...
\\ \midrule
\wss{Input} & \wss{$v^{\text{i}}: \mathbb{R}, a^{c}: \mathbb{R}, t: \mathbb{R}$}
\\ \midrule
\wss{Output} & \wss{${v}(t): \mathbb{R} \rightarrow \mathbb{R}$}
\\ \midrule
...
\\ \midrule
\wss{Input} & \wss{$p^{\text{i}}: \mathbb{R}, v^{\text{i}}: \mathbb{R}, a^{c}: \mathbb{R}, t: \mathbb{R}$}
\\ \midrule
\wss{Output} & \wss{${p}(t): \mathbb{R} \rightarrow \mathbb{R}$}
\\ \midrule
\wss{Input Constraints} & \wss{$t \geq 0$} \wss{\hyperref[timeStartZero]{A:timeStartZero}}
\\ \midrule
\wss{Output Constraints} & \wss{None}
...
\subsubsection{\wss{Helper Theories (GD:velVec and GD:posVec)}}
                                                                                                                                                                                                 ...
                                                                                                                                                                                                 \end{bmatrix}$ and the acceleration vector as $\symbf{a}\text{(}t\text{)}=\begin{bmatrix}
                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                           \end{bmatrix}$. The acceleration is assumed to be constant in both the $x$ direction ${a_{\text{x}}}^{\text{c}}$ (\hyperref[constAccelX]{A:constAccelX}) and $y$ direction ${a_{\text{y}}}^{\text{c}}$ (\hyperref[constAccelY]{A:constAccelY}). The constant acceleration vector is represented as ${\symbf{a}^{\text{c}}}=\begin{bmatrix}
                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                           \end{bmatrix}$. The initial velocity (at $t=0$, from \hyperref[timeStartZero]{A:timeStartZero}) is represented by ${\symbf{v}^{\text{i}}}=\begin{bmatrix}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     {{v_{\text{x}}}^{\text{i}}}\\
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     {{v_{\text{y}}}^{\text{i}}}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \end{bmatrix}$. \wss{For each coordinate direction we satisfy the preconditions for \hyperref[GD:rectVel]{GD:rectVel}. This means we can use the one dimensional equation for each of the two coordinate directions to yield the required equation:}
