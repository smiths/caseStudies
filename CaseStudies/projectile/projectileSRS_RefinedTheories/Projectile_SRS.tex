...
\subsubsection{\wss{General Theories (GD:velVec and GD:posVec)}}
...
\noindent \textbf{Theories Used by PT:coordSyst}
...
\noindent \textbf{Theories Used by PT:velVecInitMagAndAngle}
...
\noindent \textbf{Theories Used by PT:posVecInitMagAndAngle}
...
\noindent \textbf{Theories Used by PT:posVecInitPos}
...
\noindent \textbf{Theories Used by PT:velVecPlanetaryGrav}
...
\noindent \textbf{Theories Used by PT:posVecPlanetaryGrav}
...
\noindent \textbf{Theories Used by IM:calOfLandingTime}
...
\noindent \textbf{Theories Used by IM:calOfLandingDistDeriv}
...
\noindent \textbf{Theories Used by IM:offsetIM}
...
\noindent \textbf{Theories Used by IM:messageIM}
