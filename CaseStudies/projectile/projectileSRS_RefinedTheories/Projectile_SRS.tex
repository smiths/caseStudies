...
its orientation \hyperref[SD:noOrient]{SD:noOrient}.} %this is how we leave theories out, like theories of rotation
...
\item[magAngleRep:\phantomsection\label{magAngleRep}]\wss{Use the magnitude and angle representation for the initial velocity vector. (RefBy: \hyperref[PT:velVecInitMagAndAngle]{PT:velVecInitMagAndAngle})}
...
$θ$ is shown in \hyperref[Figure:Launch]{Fig:Launch}.  This equation inherits the assumptions from \hyperref[GD:magAngleToCompRep]{GD:magAngleToCompRep}: \hyperref[MD:cartSyst]{MD:cartSyst} and \hyperref[twoD]{A:twoD}.
...
(\hyperref[magAngleRep]{A:magAngleRep}).  That is,
...
\item \hyperref[magAngleRep]{A:magAngleRep}
\end{itemize}
...
\hyperref[PT:coordSyst]{PT:coordSyst}) \item
\hyperref[magAngleRep]{A:magAngleRep} 
\end{itemize} 
...
\item \hyperref[magAngleRep]{A:magAngleRep} (inherited from \hyperref[PT:posVecPlanetaryGrav]{PT:posVecPlanetaryGrav})
...
\item \hyperref[magAngleRep]{A:magAngleRep} (inherited from \hyperref[IM:calOfLandingDist]{IM:calOfLandingDist})
...
\item \hyperref[magAngleRep]{A:magAngleRep} (inherited from \hyperref[IM:offsetIM]{IM:offsetIM})
