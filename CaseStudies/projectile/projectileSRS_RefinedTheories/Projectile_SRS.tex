...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule
Notes & The velocity and acceleration of the body are expressed using a Cartesian
coordinate system (\hyperref[CT:CartCoordSyst]{CT:CartCoordSyst}, \hyperref[cartSyst]{A:cartSyst}).  That is, the coordinate
system is rectangular (orthonormal).
\\ \midrule
...
\\ \midrule
\wss{Input} & \wss{$\symbf{p}: \text{time} \rightarrow \mathbb{R}^3$}
\\ \midrule
\wss{Output} & \wss{$\symbf{v}: \text{time} \rightarrow \mathbb{R}^3$}
\\ \midrule
\wss{Input Constraints} & \wss{None}
\\ \midrule
\wss{Output Constraints} & \wss{None}
\\ \midrule
...
coordinate system (\hyperref[cartSyst]{A:cartSyst}).  That is, the coordinate
system is rectangular (orthonormal).
\\ \midrule
...
\\ \midrule
\wss{Input} & \wss{$\alpha: \mathbb{R}, \beta: \mathbb{R}, \gamma: \mathbb{R},
|\symbf{b}|: \mathbb{R}$}
\\ \midrule
\wss{Output} & \wss{$b_x: \mathbb{R}, b_y: \mathbb{R}, b_z: \mathbb{R}$}
\\ \midrule
\wss{Input Constraints} & \wss{$\cos^2(\alpha) + \cos^2(\beta) + \cos^2(\gamma) = 1$}
\\ \midrule
\wss{Output Constraints} & \wss{None}
\\ \midrule
...
\\ \midrule
Description & \begin{symbDescription}
              \item $\alpha$ is the angle between the vector and the positive $x$ axis 
              \item $\beta$ is the angle between the vector and the positive $y$ axis 
              \item $\gamma$ is the angle between the vector and the positive $z$ axis 
              \item $|\symbf{b}|$ is the magnitude of the vector
              \item $b_x$ is the $x$ component of the vector $\symbf{b}$
              \item $b_y$ is the $y$ component of the vector $\symbf{b}$
              \item $b_z$ is the $z$ component of the vector $\symbf{b}$
              \end{symbDescription}
\\ \midrule
Notes & \wss{The vector $\symbf{b}$ is in a three dimensional Cartesian
coordinate system (\hyperref[cartSyst]{A:cartSyst}).}  \wss{A figure showing the
angles for a sample vector would be a nice addition.}
\\ \midrule
...
\\ \midrule
\wss{Input} & \wss{$v^{\text{i}}: \mathbb{R}, a^{c}: \mathbb{R}, t: \text{time}$}
\\ \midrule
\wss{Output} & \wss{${v}: \mathbb{R}$}
\\ \midrule
\wss{Input Constraints} & \wss{$t \geq 0$} \wss{\hyperref[timeStartZero]{A:timeStartZero}}
\\ \midrule
\wss{Output Constraints} & \wss{None}
\\ \midrule
Equation & \begin{displaymath}
...
\\ \midrule
\wss{Input} & \wss{$p^{\text{i}}: \mathbb{R}, v^{\text{i}}: \mathbb{R}, a^{c}: \mathbb{R}, t: \text{time}$}
\\ \midrule
\wss{Output} & \wss{${p}: \mathbb{R}$}
\\ \midrule
\wss{Input Constraints} & \wss{$t \geq 0$} \wss{\hyperref[timeStartZero]{A:timeStartZero}}
\\ \midrule
\wss{Output Constraints} & \wss{None}
...
(\hyperref[constAccel]{A:constAccel}) represented by ${a^{c}}$. The initial
velocity (at $t=0$, from \hyperref[timeStartZero]{A:timeStartZero}) is
represented by ${v^{\text{i}}}$. Since we satisfy the preconditions for \hyperref[GD:rectVel]{GD:rectVel} we can replace $v(t)$ to get:}
...
\\ \midrule
\wss{Input} & \wss{$v_{\text{x}}^{\text{i}}: \mathbb{R}, v_{\text{y}}^{\text{i}}: \mathbb{R}, {a_{\text{x}}}^{\text{c}}: \mathbb{R}, {a_{\text{y}}}^{\text{c}}: \mathbb{R},t: \text{time}$}
\\ \midrule
\wss{Output} & \wss{$\symbf{v}: \mathbb{R}^2$}
\\ \midrule
\wss{Input Constraints} & \wss{$t \geq 0$} \wss{\hyperref[timeStartZero]{A:timeStartZero}}
\\ \midrule
\wss{Output Constraints} & \wss{None}
...
\\ \midrule
\wss{Input} & \wss{$p_{\text{x}}^{\text{i}}: \mathbb{R}, v_{\text{x}}^{\text{i}}: \mathbb{R}, p_{\text{y}}^{\text{i}}: \mathbb{R}, v_{\text{y}}^{\text{i}}: \mathbb{R}, {a_{\text{x}}}^{\text{c}}: \mathbb{R}, {a_{\text{y}}}^{\text{c}}: \mathbb{R},t: \text{time}$}
\\ \midrule
\wss{Output} & \wss{$\symbf{p}: \mathbb{R}^2$}
\\ \midrule
\wss{Input Constraints} & \wss{$t \geq 0$} \wss{\hyperref[timeStartZero]{A:timeStartZero}}
\\ \midrule
\wss{Output Constraints} & \wss{None}
...
\\ \midrule
\wss{Input} & \wss{$\theta: \mathbb{R}, |\symbf{b}|: \mathbb{R}$}
\\ \midrule
\wss{Output} & \wss{$b_x: \mathbb{R}, b_y: \mathbb{R}$}
\\ \midrule
\wss{Input Constraints} & \wss{None}
\\ \midrule
\wss{Output Constraints} & \wss{None}
...
\\ \midrule
Description & \begin{symbDescription}
              \item $\theta$ is the angle between the vector and the positive $x$ axis 
              \item $|\symbf{b}|$ is the magnitude of the vector
              \item $b_x$ is the $x$ component of the vector $\symbf{b}$
              \item $b_y$ is the $y$ component of the vector $\symbf{b}$
              \end{symbDescription}
...
the angle $\gamma$ is not relevant.  The angle will be $\pi/2$, so the
$\cos(\gamma) = \cos(\pi/2) = 0$.  In the 2D case we rename the angle $\alpha$
as $\theta$.  The angle $\beta$ is related to $\theta$ by $\beta = \pi/2 -
\theta$; therefore, $\cos(\beta) = \cos(\pi/2 - \theta) = \sin(\theta)$.}
\\ \midrule
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule
Notes & \wss{This equation is a relabelling of
...
Notes & \wss{This equation is a relabelling of
\hyperref[GD:magAngleToCompRep]{GD:magAngleToCompRep}$ - {v^{\text{i}}}$ is
$|\symbf{b}|$, ${v_{\text{y}}}^{\text{i}}$ is $b_y$ and $\theta$ is $\theta$.}  $θ$ is shown in \hyperref[Figure:Launch]{Fig:Launch}.
