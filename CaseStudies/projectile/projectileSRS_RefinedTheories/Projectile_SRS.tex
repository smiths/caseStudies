...
its orientation \hyperref[A:noOrientation]{A:noOrientation}.} %this is how we leave theories out, like theories of rotation
...
\subsubsection{\wss{Refined Theories}}
\label{Sec:GDs}
...
\\ \midrule
\wss{Input Constraints} & \wss{$t \geq 0$}
\\ \midrule
\wss{Output Constraints} & \wss{None}
\\ \midrule
Equation & \begin{displaymath}
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule
Notes & Start with acceleration background theory.  Remove two dimensions.
Assume acceleration is constant.  Assume we have an initial velocity as input.
\\ \midrule
