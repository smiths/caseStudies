...
components \(v_x^i\) and \(v_y^i\), as shown in Figure \ref{fig:org09398fa}.
...
\caption{\label{fig:org09398fa}Coordinate System and Definition of Symbols}
\end{figure}
